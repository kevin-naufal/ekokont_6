...
const ProfilePictureShop = ({ profilePicture, setProfilePicture }) => {
  ...
  const handleSaveCroppedImage = async () => {
    ...
    localStorage.setItem('profilePictureShop', croppedImage);  // Updated key name for shop
  ...
  const handleDeleteProfilePicture = () => {
    ...
    localStorage.removeItem('profilePictureShop');  // Updated key name for shop
    setAnchorEl(null); // Close menu
  };
  ...
  const hasProfilePicture = profilePicture && profilePicture !== guestProfilePicture;
...
export default ProfilePictureShop;
